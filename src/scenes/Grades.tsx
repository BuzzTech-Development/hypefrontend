...
const Grades = (props: any) => {
    ...
    // display list of assignments that that student has submitted

    return (<Space direction='vertical' size='large' style={{width: '80%'}}>
        {assignments.length === 0 ? null : <SubmissionList assignments={assignments}/>}
    </Space>)
}
...
const SubmissionList = (props: any) => {
    ...
    assignments.sort(function(a: Assignment, b: Assignment) {
        if (a.due_date === a.due_date) return 0;
